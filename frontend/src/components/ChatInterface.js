...
export default function ChatInterface({ videoId }) {
    ...
    return (
        <div className="flex-1 flex flex-col h-[calc(100vh-7rem)] rounded-lg overflow-hidden bg-dark-800/90">
            <div className="p-4 border-b border-dark-700">
                <h2 className="text-base font-medium text-white">Chat Assistant</h2>
            </div>
